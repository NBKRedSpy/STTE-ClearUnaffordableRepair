# Shortest Trip To Earth - Clear Unaffordable Repair
...
Delete the directory ```<Steam Directory>\steamapps\common\Shortest Trip to Earth\BepInEx\plugins\ClearUnaffordableRepair```.
